...
<head>
    ...
    <title>Maijah Taejon - Official Site</title>
    ...
    <style>
        .main-content {
            ...
            flex-grow: 1;
            background: url('assets/images/maijah_background.png') center 50px / cover no-repeat; /* Default for desktop */
        }
        ...
        @media (min-width: 769px) {
            ...
            .main-content {
                background-position: center 50px; /* Adjustable for desktop */
            }
        }
        @media (max-width: 768px) {
            .main-content {
                background-position: center 65px; /* Adjustable for mobile */
            }
        }
        .text-wrapper {
            padding-top: 140px; /* Pushes the text down by 140px; adjust as needed */
        }
    </style>
</head>
<body>
    <div class="page-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="text-wrapper">
                <h1 class="movie-title">Welcome to the Official Site of Maijah Taejon</h1>
                <p class="pitch-text">
                    Discover new music, videos, and exclusive content.
                </p>
            </div>
            <!-- Example audio player (optional) -->
